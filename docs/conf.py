...
release = __import__('eve_sqlalchemy').__version__
...
texinfo_documents = [
    ('index', 'Eve', u'Eve SQLAlchemy Documentation',
     u'Dominik Kellner', 'Eve SQLAlchemy', 'One line description of project.',
     'Miscellaneous'),
]
